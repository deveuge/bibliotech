    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div>¿Desea solicitar el libro "<span id="solicitud-libro"></span>" de <span id="solicitud-autor"></span>?</div>
            ...
            <div class="modal-footer">
                ...
                <form action="prestamo.php" method="POST">
                    <input type="hidden" name="accion" value="solicitar-catalogo"/>
                    <input type="hidden" id="solicitud-isbn" name="isbn" value=""/>
